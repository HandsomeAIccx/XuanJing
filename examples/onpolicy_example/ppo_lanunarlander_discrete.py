...
def ppo_args():
    ...
    parser.add_argument('--actor_net', type=list, default=[512, 512])
    parser.add_argument('--critic_net', type=list, default=[512, 256])
    ...
    parser.add_argument("--scheduling_lr_bound", type=int, default=1000000)
