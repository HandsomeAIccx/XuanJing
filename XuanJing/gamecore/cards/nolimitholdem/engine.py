...
ref: https://github.com/fschlatt/clubs
"""
import itertools
import operator
import sys
...
from XuanJing.gamecore.cards.nolimitholdem import error
from XuanJing.gamecore.cards.nolimitholdem.card import Card, Deck
from XuanJing.gamecore.cards.nolimitholdem.evaluator import Evaluator
...
class Dealer:
    ...
    def _eval_hands(
        self, hole_cards: List[List[Card]], community_cards: List[Card]
    ) -> List[int]:
